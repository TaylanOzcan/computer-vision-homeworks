...
extra_test_data_path = fullfile(data_path,'extra_test_scenes'); %Extra test scenes
...
[bboxes, confidences, image_ids] = ...
    run_detector(extra_test_data_path, svmClassifier, hog_template_size,hog_cell_size);
...
%visualize_detections_by_image(bboxes, confidences, image_ids, tp, fp, test_data_path, test_label_path)
 visualize_detections_by_image_no_gt(bboxes, confidences, image_ids, extra_test_data_path)
